...
# To Do List:
WORDS = ['ABBA','HAM','SCHOOL','SOCIETY','HYUNDAI','BMW','BENZ','PORSCHE','MISSILE','TANK','HOUSE','DREAM','TOUR','YACHT','ROYAL','SUN','MOON','PHONE','SUBWAY','AIRPLANE','KING','QUEEN','BABY','STAR','AUTUMN','SUMMER','SPRING','WINTER', 'NATURE','EARTH']
